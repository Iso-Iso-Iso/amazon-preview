...
@Module({
    ...
    providers: [AxiosService, AdGroupsApiService, CampaignApiService, ProfileApiService],
    exports: [HttpModule, AdGroupsApiService, CampaignApiService, ProfileApiService],
})
